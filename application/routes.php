...
return array(
	...
	*/
	...
	'GET /' => array('name' => 'home', 'do' => function()
	{
		...
		$view->head_title = 'App home page';
		$view->content = View::make('partials/home');

		return $view;
	}),

	'GET /page' => array('name' => 'page', 'do' => function()
	{
		$view = View::make('layout');

		$view->head_title = 'My static page';
		$view->content = View::make('partials/static_page');

		return $view;
	}),

	'GET /secret' => array('name' => 'secret', 'before' => 'auth', 'do' => function()
	{
		$view = View::make('layout');

		$view->head_title = 'Secret page';
		$view->content = View::make('partials/secret_page');
