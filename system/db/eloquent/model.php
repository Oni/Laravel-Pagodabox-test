...
abstract class Model {
	...
	public static function table($class)
	{
		...
		return strtolower(Inflector::plural(static::modeln($class)));
	}
	 ...
	 * @return string
	 */
	public static function modeln($model)
	{
	...
	{
		$this->relating_key = (is_null($foreign_key)) ? strtolower(static::modeln($this)).'_id' : $foreign_key;
	...
	public function has_and_belongs_to_many($model, $table = null, $foreign_key = null, $associated_key = null)
	{
		...
		$associated_key = (is_null($associated_key)) ? strtolower(static::modeln($model)).'_id' : $associated_key;
	...
	{
		$models = array(Inflector::plural(static::modeln($model)), Inflector::plural(static::modeln($this)));
